...
(function ($, undefined) {
    ...
    function formDataObject(input, form) {
        ...
        //var lastT = allSeries[allSeries.length - 1];
        //if (input != "" && lastT == undefined && (allSeries.length == 0)) {
        //    return { 'input': input, 'form': form };
        //} else {
        //    if (input != "" && lastT != undefined && allSeries.length >= 2 && (input.trim() == lastT.trim())) {
        //        Common.E2MASNotification("Already last model name is - " + input.trim(), Common.Warning);
        //        return false;
        //    }
        //    else {
        return { 'input': input, 'form': form };

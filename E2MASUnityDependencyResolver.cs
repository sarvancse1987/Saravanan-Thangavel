...
namespace E2MAS.Web.GUI.Models.E2MAS
{
    public class E2MASUnityDependencyResolver : IDependencyResolver
    {
        private const string HttpContextKey = "perRequestContainer";
        private readonly IUnityContainer _container;
        public E2MASUnityDependencyResolver(IUnityContainer container)
        {
